document.addEventListener('DOMContentLoaded', () => {
    const dishes = [
        ...
        { id:5, name:"Trà Sữa ToCoToCo", category:"Đồ uống", price:28000, rating:4.5, img:"https://tocotocotea.com/wp-content/uploads/2024/10/Hinh-1-9.jpg" },
        { id:6, name:"Kem Xôi Tràng Tiền", category:"Tráng miệng", price:32000, rating:4.8, img:"https://kemtrangtien.vn/upload/feature/thumb_1920x0/bannerkem-xoi-mobile-1709523965.png" },
        // thêm món nếu muốn
    ];
    ...
    function updateCart() {
        ...
        document.getElementById('floatingCount').textContent = cart.length;
        // render cart items... (có thể mở rộng sau)
    }
    ...
    document.addEventListener('click', e => {
        if (e.target.classList.contains('add-btn')) {
            ...
            cart.push({...dish, qty:1, spicy:2, note:''});
            updateCart();
